---
title: "Rules Primer"
link_title: "Rules Primer"
permalink: /rules/den-of-wolves-2026/rules-primer/
nav_order: 1
---
...
**There may be traitors within the fleet.**
...
Resources and units are tracked on the honor system. When a station produces food, you walk to the resource table and take it — no one is checking. When you use a crew counter, you turn it face-down yourself.
...
## Freeform Actions & Shenanigans

The hallmark of Megagames. If you have an idea of something you think you'd be able to do within the game universe, talk to Control about it. They will work with you to help it happen. There will be costs associated with any Freeform Action, and will likely involve collaborating with other players.
...
**No ship is self-sufficient.** Every ship in the fleet is specialized — some produce food, some water, some refine fuel, some repair damage. Your ship almost certainly makes more of something than it needs and runs short on something it can't produce at all.

**There are no fixed prices.** Resources are worth whatever both parties agree they're worth. You can give things away for free, drive a hard bargain, or anything in between. There's no rule that says you have to trade — but the fleet will fall apart if ships hoard. The game is *designed* around cooperation. A neighbor in crisis is both a political problem and an opportunity.

**If you're not sure where to start** — ask your Chief Engineer what you're producing and what you're short on. Then go talk to another ship.

## Shuttles

Shuttles are **the only way** to move Units, Crew, or resources between ships.
...
**Crew** have a white background. Crew are used to Activate Stations. They have other uses outlined in the game components and can be used for freeform actions.
...
When Crew are used, they're turned **face down**. Face-down Crew cannot be activated again until the next turn and cannot be transported via Shuttle to another ship.
...
**Units placed in the Ready Room at the start of the turn** get a +1 bonus to their first roll against boarders. This is on the honor system — they must be placed there *before* a Wolf Attack is announced.
